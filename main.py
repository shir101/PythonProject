...
#  אם ניצקל במקרה שסיווגנו גנום  שמתאים ליותר ממשפחה אחת נבדוק האם הקיימרים שהגדרנו כמייצגים הם אכן כאלה או שהם גנרים וצריך לזרוק אותם ונבדוק גם האם בחרנו ערך סף טוב מספיק
...
def database1_build(database1 , rep_threshold): #rep_threshold - הסף שצריך לעבור בשהיל לומר שהקיימר מייצג את המשפחה
